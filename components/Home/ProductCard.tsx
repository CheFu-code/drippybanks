    ...
    return (
        ...
        >
            <div className="relative overflow-hidden aspect-3/4 mb-4 bg-gray-100 rounded-lg">
                ...
                <button className="absolute bottom-4 right-4 bg-white p-3 rounded-full shadow-lg translate-y-12 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 hover:bg-gray-50">
                    <Plus size={20} />
                </button>
