        ...
        <footer className="bg-slate-950 text-slate-100 pt-16 pb-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-12 lg:grid-cols-4 mb-14">
                    <div className="space-y-4">
                        ...
                        <h3 className="text-2xl font-semibold text-white">
                            Premium streetwear with a modern edge.
                        </h3>
                        <p className="text-sm leading-7 text-slate-400">
                            Built for bold style, crafted for lasting wear, and designed to
                            feel luxurious from every angle.
                        </p>
                        <div className="flex items-center gap-3 text-slate-400">
                            <a
                                target="_blank"
                                rel="noopener noreferrer"
                                href="https://www.instagram.com/drippy_banks_clothing?igsh=OGxxZXJoMGN1NXd6&utm_source=qr"
                            ...
                            <a
                                target="_blank"
                                rel="noopener noreferrer"
                                href="https://www.tiktok.com/@drippybanks2025?_r=1&_t=ZS-98uGJiJzvRV"
                                className="rounded-full border border-white/10 bg-white/5 p-3 text-slate-200 transition hover:border-amber-300/30 hover:bg-amber-400/10"
                            >
                                <FaTiktok size={18} />
                            </a>
                            <a
                                target="_blank"
                                rel="noopener noreferrer"
                                href="https://www.facebook.com/share/1CxS8UqnKU/?mibextid=wwXIfr"
                                className="rounded-full border border-white/10 bg-white/5 p-3 text-slate-200 transition hover:border-amber-300/30 hover:bg-amber-400/10"
                            >
                                <Facebook size={18} />
                            </a>
                    ...
                    <div>
                        ...
                        <p className="text-sm leading-7 text-slate-400 mb-5">
                            Subscribe for release alerts, exclusive offers, and early access
                            to new drops.
                        </p>
                        ...
                        {message && (
                            <p
                                className={`mt-3 text-xs ${message.type === "success" ? "text-emerald-300" : "text-rose-300"}`}
                            >
                                {message.text}
                            </p>
                        )}
                ...
                <div className="border-t border-white/10 pt-8 flex flex-col gap-3 text-sm text-slate-500 md:flex-row md:items-center md:justify-between">
                    <p>
                        &copy; {new Date().getFullYear()} DrippyBanks Inc. All rights
                        reserved.
                    </p>
                    <p>
                        Built by{" "}
