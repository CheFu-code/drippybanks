...
const SECTIONS = [
    ...
    { id: 'single-sign-on', title: '4. Single Sign-On & Account Sharing', icon: Share2 },
                ...
                <header className="relative rounded-3xl border border-white/10 bg-slate-900/60 p-8 sm:p-12 mb-12 overflow-hidden shadow-2xl backdrop-blur-xl">
                    ...
                    <div className="relative z-10 max-w-3xl">
                        ...
                        <p className="mt-4 text-base sm:text-lg text-slate-300 leading-relaxed">
                            We value your trust and are committed to protecting your personal information. This Privacy Policy details how we collect, safeguard, and utilize data across our online store and unified account network.
                        </p>
                    ...
                    <article className="lg:col-span-8 space-y-12 text-slate-300 text-sm sm:text-base leading-relaxed">
                        ...
                        <section id="information-collected" className="rounded-2xl border border-white/10 bg-slate-900/50 p-6 sm:p-8 space-y-4">
                            ...
                            <ul className="list-disc pl-6 space-y-2 text-slate-300">
                                <li>
                                    <strong className="text-white">Account Information:</strong> When you register through our unified login system or create an account, we collect your name, email address, phone number, and avatar image.
                                </li>
                                <li>
                        ...
                        <section id="how-we-use-info" className="rounded-2xl border border-white/10 bg-slate-900/50 p-6 sm:p-8 space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                                ...
                                <div className="p-4 rounded-xl bg-slate-950/60 border border-white/5">
                                    ...
                                    <p className="text-xs text-slate-400">Maintaining your unified profile, wishlists, cart persistence, and personalized size recommendations.</p>
                                </div>
                                <div className="p-4 rounded-xl bg-slate-950/60 border border-white/5">
                        ...
                        <section id="chefu-ecosystem" className="rounded-2xl border border-white/10 bg-slate-900/50 p-6 sm:p-8 space-y-4">
                            <div className="flex items-center gap-3">
                                ...
                                <h2 className="text-xl sm:text-2xl font-bold text-white">4. Unified Account & Data Sharing</h2>
                            </div>
                            <p>
                                Drippy Banks is integrated into our <strong className="text-white">Centralized Identity Ecosystem</strong>. When you log in with your account, authentication credentials and unified profile details are processed securely across connected platform services.
                            </p>
                        ...
                        <section id="data-retention" className="rounded-2xl border border-white/10 bg-slate-900/50 p-6 sm:p-8 space-y-4">
                            ...
                            <p>
                                We retain personal information for as long as your account is active, or as required to fulfill purchases, comply with tax and statutory accounting obligations in South Africa, resolve disputes, and enforce our agreements.
                            </p>
                            <p>
